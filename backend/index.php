<!DOCTYPE html>
<html>
<title>Vacante in Pandilie</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-white w3-border-bottom w3-xlarge">
  <a href="login.php" class="w3-bar-item w3-button w3-text-red w3-hover-red w3-right">Login</a>
  <a href="#" class="w3-bar-item w3-button w3-right w3-hover-red w3-text-grey"><i class="fa fa-search"></i></a>
</div>

<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="images/london.png" alt="London" width="1500" height="700">
...
<div class="w3-content" style="max-width:1100px;">
  <div class="w3-container">
   ...
   <div class="w3-container">
    <h2>Contact</h2>
    <p>hai sa gasim urmatoare vacnta impreuna.</p>
